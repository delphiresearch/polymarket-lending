...
export const AreaChart = AreaChartPrimitive
export const Area = AreaPrimitive
export const BarChart = BarChartPrimitive
export const Bar = BarPrimitive
export const LineChart = LineChartPrimitive
export const Line = LinePrimitive
export { CartesianGrid, XAxis, YAxis }
    ...
    return (
      ...
      >
        <div className="grid gap-0.5">
          {labelFormatter ? (
            <p className="text-xs font-medium text-muted-foreground">{labelFormatter(label || "")}</p>
          ) : (
          ...
          {payload.map((item, index) => {
            ...
            if (formatter) {
              ;[value, name] = formatter(item.value, item.name, item)
            }
